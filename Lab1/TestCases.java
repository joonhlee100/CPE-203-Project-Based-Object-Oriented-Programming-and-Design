...
public class TestCases{
   ...
   {
      assertEquals(6.9, SimpleIf.max(6.9, 3.3), DELTA);
   ...
   public void testSimpleArray3()
   {
      assertArrayEquals(
        new int[] {64, 0, 144},
        SimpleArray.squareAll(new int[] {8, 0, 12}));
   ...
   {
      List<Integer> input =
         new LinkedList<Integer>(Arrays.asList(new Integer[] {0, 4, 8}));
      List<Integer> expected =
         new ArrayList<Integer>(Arrays.asList(new Integer[] {0, 16, 64}));
   ...
   {
      assertFalse(BetterLoop.contains(new int[] {0, 1, 2, 3, 4}, -1));
   ...
   {
            List<String> expected = Arrays.asList("Joon");
      Map<String, List<Course>> courseListsByStudent = new HashMap<>();

      courseListsByStudent.put("Joon",
         Arrays.asList(
            new Course("CPE 202", 4),
            new Course("CPE 203", 4),
            new Course("CPE 225", 4),
